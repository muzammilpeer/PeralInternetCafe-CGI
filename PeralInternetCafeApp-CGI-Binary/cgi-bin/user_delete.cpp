...
int main()
{
   ...
   // output html element and some of its contents
      ...
      <<"-->"
     <<"</style>";
     cout<<"<body><h5>Pearl Server >> User >> Total User</h5>"
      <<"<h1>Password Search Session </h1></hr><p></p>";
      ...
      char pass[30];
      char name[30];
      cout<<"<p class=\"style1\"><b><i> Results </b></i></p>";
    cout<<"<table width=\"500\" border=\"1\">"
    <<"<tr>"
    <<"<td width=\"10\"><p class=\"style1\"><b><i> File Name </b></i></p></td>"
    <<"<td width=\"10\"><p class=\"style1\"><b><i> Status </b></i></p></td>"
    <<"</tr>";
    ...
    in>>name;    
        ...
        int l=0;
             ...
             {
             cout<<"<td>"<<name<<"</td>";
             cout<<"<td>Truncated</td>";
             }
             else cout<<"<p> No file is Found </p>";
        }
        cout<<"</tr>";
    }
    cout<<"</table>";
